...
<div style="width: 1100px;">
    <form class="form-horizontal" action="../../CONT/produtos.php" method="post" onsubmit="return">
        ...
        <fieldset>
            ...
            <?php } ?>
            <!-- Form Name -->
            <legend style="margin: 20px;">Codastrar produto<br/></legend>
            <!-- Text Input Nome -->
            <div class="form-group">
                <label class="col-md-4 control-label" for="nome">Nome do Produto:</label>
                <div class="col-md-4">
                    <input id="nome" name="nome" type="text" placeholder="Digite o nome de seu produto" class="form-control input-md x500" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="descricao" name="descricao" type="text" placeholder="Descrição do Produto" class="form-control input-md x500" required>
                    <span class="help-block">Este campo é obrigatorio</span>
                </div>
            </div>
            <!-- Text Input Preço -->
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="preco" name="preco" type="text" placeholder="Ex.: 50.00" class="dinheiro form-control input-md x500" style="display:inline-block" required>
                    <span class="help-block">Este campo é obrigatorio</span>
                </div>
            </div>
            <!-- IMG -->
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="x500">
                        <select id="selectbasic" name="categoria" class="form-control" style="float: left; width: 372px; margin-right: 4px" required>
                        ...
                        <a class="btn btn-primary btnn" style="float: left" href="./cadCategoria.php">Novo Categoria</a>
                    </div>
                </div>
            </div>
            <!-- Button -->
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="submit" id="singlebutton" name="singlebutton" class="btn btn-primary btnn" value="Confirmar"/>
                </div>
            </div>
        </fieldset>
    </form>
