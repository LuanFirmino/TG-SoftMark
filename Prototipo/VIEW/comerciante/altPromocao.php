...
$info = DBRead("promocao", "where cecomerciante = '$_COOKIE[codComer]'");
?>
<!doctype html>
<html lang="pt-br">
<head>
...
<div style="width: 1100px;">
    <form class="form-horizontal" action="../../CONT/promocao.php" method="post" onsubmit="return">
        ...
        <fieldset>
            ...
            <!-- Text Input Desconto -->
            <div class="form-group">
                <label class="col-md-4 control-label" for="preco">Desconto:</label>
                <div class="col-md-4">
                    <input id="preco" name="preco" type="text" placeholder="Ex.: 70%" class="form-control input-md x500" required>
                    <span class="help-block">Este campo é obrigatorio</span>
                </div>
            </div>
            <!-- Data Input Final -->
            <div class="form-group">
                <label class="col-md-4 control-label" for="preco">Termino da Promoção:</label>
                <div class="col-md-4">
                    <input id="preco" name="preco" type="date" placeholder="Ex.: 50.00" class="form-control input-md x140" required>
                    <span class="help-block">Este campo é obrigatorio</span>
                </div>
            </div>
            <!-- Button -->
