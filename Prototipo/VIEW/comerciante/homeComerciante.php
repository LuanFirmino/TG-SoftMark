            ...
            <nav class="navbar navbar-inverse" role="navigation">
                <div class="container-fluid corBarra">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="homeComerciante.php" style="color: black;">Pague Pouco</a>
                    </div>
                    <!-- Collect the nav links, forms, and other content for toggling -->
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            <li class=""><a href="./listaProdutos.php" target="teste" style="color: black;">Meus Produtos</a></li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="" style="color: black;">Cadastros <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <li><a href="./cadProdutos.php"    target="teste"  style="color: black;">Cadastrar Produtos</a></li>
                                    <li><a href="./cadPromocao.php"    target="teste"  style="color: black;">Cadastrar Promoções</a></li>
                                </ul>
                            </li>
                        </ul>
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="cadComerciante.php" target="teste">Minha Conta</a></li>
                                    <li class="divider"></li>
